...
class WC_Settings_Emails extends WC_Settings_Page {
	...
	public function email_notification_setting_block_emails() {
		...
		// Create URL for email editor template mode. With lazy post creation
		// there may be no post yet — the client then creates one on demand and
		// builds the URL itself from the template ID passed below.
